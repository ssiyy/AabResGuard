...
import com.bytedance.android.aabresguard.utils.elf.ElfSectionHeaderConstants;
import com.bytedance.android.aabresguard.utils.elf.StringUtilities;
...
public class ElfSectionHeaderType {
	 ...
	 * @throws Exception if new type name already defined within
	 * the specified map
	 */
	public static void addSectionHeaderType(ElfSectionHeaderType type,
			Map<Integer, ElfSectionHeaderType> sectionHeaderTypeMap) throws Exception {
